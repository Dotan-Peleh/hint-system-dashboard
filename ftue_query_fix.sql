...
funnel_flags AS (
  SELECT
    ...
    MAX(CASE WHEN ue.mp_event_name = 'click_board_button_scapes'
          ...
          AND (ue.res_timestamp - a.ts_flow1_step1) / 60000 <= 30
          AND (a.ts_flow1_step2 IS NULL OR ue.res_timestamp <= a.ts_flow1_step2)
    ...
    MAX(CASE WHEN ue.mp_event_name = 'generation'
          ...
          AND (ue.res_timestamp - a.ts_flow1_step2) / 60000 <= 30
    ...
    MAX(CASE WHEN ue.mp_event_name = 'merge'
          ...
          AND (ue.res_timestamp - a.ts_flow1_step3) / 60000 <= 30
    ...
    MAX(CASE WHEN ue.mp_event_name = 'board_tasks_task_ready'
          ...
          AND (ue.res_timestamp - a.ts_flow1_step4) / 60000 <= 30
    ...
    MAX(CASE WHEN ue.mp_event_name = 'click_board_tasks_go'
          ...
          AND (ue.res_timestamp - a.ts_flow1_step5) / 60000 <= 30
    ...
    MAX(CASE WHEN ue.mp_event_name = 'generation'
          ...
          AND (ue.res_timestamp - a.ts_flow1_step6) / 60000 <= 30
    ...
    MAX(CASE WHEN ue.mp_event_name = 'impression_how_to_play'
          ...
          AND (ue.res_timestamp - a.ts_flow1_step7) / 60000 <= 30
    ...
    MAX(CASE WHEN ue.mp_event_name = 'impression_dialog' AND ue.dialog_id = '10013'
          ...
          AND (ue.res_timestamp - a.ts_flow2_step0) / 60000 <= 30
    ...
    MAX(CASE WHEN ue.mp_event_name = 'impression_dialog' AND ue.dialog_id = '10015'
          ...
          AND (ue.res_timestamp - a.ts_flow2_step1) / 60000 <= 30
...
monotonic_flags AS (
  SELECT
    ...
    step_37 * step_34 * step_33 * step_32 * step_31 * step_30 * step_29 * step_28 * step_27 * step_26 * step_25 * step_24 * step_23 * step_22 * step_21 * step_20 * step_19 * step_18 * step_17 * step_16 * step_15 * step_14 * step_13 * step_12 * step_11 * step_10 * step_09 * step_08 * step_07 * step_06 * step_05 * step_04 * step_03 * step_02 * step_01 AS step_37,
    step_38 * step_37 * step_34 * step_33 * step_32 * step_31 * step_30 * step_29 * step_28 * step_27 * step_26 * step_25 * step_24 * step_23 * step_22 * step_21 * step_20 * step_19 * step_18 * step_17 * step_16 * step_15 * step_14 * step_13 * step_12 * step_11 * step_10 * step_09 * step_08 * step_07 * step_06 * step_05 * step_04 * step_03 * step_02 * step_01 AS step_38,
    step_39 * step_38 * step_37 * step_34 * step_33 * step_32 * step_31 * step_30 * step_29 * step_28 * step_27 * step_26 * step_25 * step_24 * step_23 * step_22 * step_21 * step_20 * step_19 * step_18 * step_17 * step_16 * step_15 * step_14 * step_13 * step_12 * step_11 * step_10 * step_09 * step_08 * step_07 * step_06 * step_05 * step_04 * step_03 * step_02 * step_01 AS step_39,
    step_40 * step_39 * step_38 * step_37 * step_34 * step_33 * step_32 * step_31 * step_30 * step_29 * step_28 * step_27 * step_26 * step_25 * step_24 * step_23 * step_22 * step_21 * step_20 * step_19 * step_18 * step_17 * step_16 * step_15 * step_14 * step_13 * step_12 * step_11 * step_10 * step_09 * step_08 * step_07 * step_06 * step_05 * step_04 * step_03 * step_02 * step_01 AS step_40,
    step_41 * step_40 * step_39 * step_38 * step_37 * step_34 * step_33 * step_32 * step_31 * step_30 * step_29 * step_28 * step_27 * step_26 * step_25 * step_24 * step_23 * step_22 * step_21 * step_20 * step_19 * step_18 * step_17 * step_16 * step_15 * step_14 * step_13 * step_12 * step_11 * step_10 * step_09 * step_08 * step_07 * step_06 * step_05 * step_04 * step_03 * step_02 * step_01 AS step_41,
    step_42 * step_41 * step_40 * step_39 * step_38 * step_37 * step_34 * step_33 * step_32 * step_31 * step_30 * step_29 * step_28 * step_27 * step_26 * step_25 * step_24 * step_23 * step_22 * step_21 * step_20 * step_19 * step_18 * step_17 * step_16 * step_15 * step_14 * step_13 * step_12 * step_11 * step_10 * step_09 * step_08 * step_07 * step_06 * step_05 * step_04 * step_03 * step_02 * step_01 AS step_42,
...
SELECT
  ...
  ROUND(step_35 / NULLIF(step_01, 0), 4) AS pct_35_ftue_flow2_1_step0_NEW,
  ROUND(step_36 / NULLIF(step_01, 0), 4) AS pct_36_ftue_flow2_1_step1_NEW,
  ROUND(step_37 / NULLIF(step_01, 0), 4) AS pct_37_ftue_flow3_step0,
  ROUND(step_38 / NULLIF(step_01, 0), 4) AS pct_38_new_chapter_2,
  ROUND(step_39 / NULLIF(step_01, 0), 4) AS pct_39_ftue_flow3_step1_ch2,
  ROUND(step_40 / NULLIF(step_01, 0), 4) AS pct_40_ftue_flow3_step2_ch2,
  ROUND(step_41 / NULLIF(step_01, 0), 4) AS pct_41_click_harvest_collect_ch2,
  ROUND(step_42 / NULLIF(step_01, 0), 4) AS pct_42_ftue_flow3_step6_ch2,
  ROUND(step_43 / NULLIF(step_01, 0), 4) AS pct_43_click_reward_center,
  ROUND(step_44 / NULLIF(step_01, 0), 4) AS pct_44_ftue_flow3_step8_ch2,
  ROUND(step_45 / NULLIF(step_01, 0), 4) AS pct_45_ftue_flow12_step0,
  ROUND(step_46 / NULLIF(step_01, 0), 4) AS pct_46_ftue_flow12_step4,
  ROUND(step_47 / NULLIF(step_01, 0), 4) AS pct_47_new_chapter_3,
  ROUND(step_48 / NULLIF(step_01, 0), 4) AS pct_48_click_harvest_collect_ch3,
  ROUND(step_49 / NULLIF(step_01, 0), 4) AS pct_49_new_chapter_4,
  ROUND(step_50 / NULLIF(step_01, 0), 4) AS pct_50_new_chapter_5,
  ...
  ROUND(step_37 / NULLIF(step_34, 0), 4) AS ratio_37_to_34,
  ...
  ROUND(step_49 / NULLIF(step_48, 0), 4) AS ratio_49_to_48,
  ROUND(step_50 / NULLIF(step_49, 0), 4) AS ratio_50_to_49
